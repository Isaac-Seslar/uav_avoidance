...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(GlobalPlannerNodeConfig::AbstractParamDescriptionConstPtr(new GlobalPlannerNodeConfig::ParamDescription<std::string>("default_node_type_", "str", 4, "Change search mode", "{'enum_description': 'Change search mode', 'enum': [{'srcline': 40, 'description': 'Normal node', 'srcfile': '/home/isaac/uav_avoidance/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'cconsttype': 'const char * const', 'value': 'Node', 'ctype': 'std::string', 'type': 'str', 'name': 'Node'}, {'srcline': 41, 'description': 'No smooth cost', 'srcfile': '/home/isaac/uav_avoidance/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'cconsttype': 'const char * const', 'value': 'NodeWithoutSmooth', 'ctype': 'std::string', 'type': 'str', 'name': 'NodeWithoutSmooth'}, {'srcline': 42, 'description': 'Search with speed', 'srcfile': '/home/isaac/uav_avoidance/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'cconsttype': 'const char * const', 'value': 'SpeedNode', 'ctype': 'std::string', 'type': 'str', 'name': 'SpeedNode'}]}", &GlobalPlannerNodeConfig::default_node_type_)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 40 "/home/isaac/uav_avoidance/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg"
      const char * const GlobalPlannerNode_Node = "Node";
//#line 41 "/home/isaac/uav_avoidance/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg"
      const char * const GlobalPlannerNode_NodeWithoutSmooth = "NodeWithoutSmooth";
//#line 42 "/home/isaac/uav_avoidance/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg"
