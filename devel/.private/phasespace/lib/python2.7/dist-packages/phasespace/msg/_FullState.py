...
"""autogenerated by genpy from phasespace/FullState.msg. Do not edit."""
import codecs
import sys
...
class FullState(genpy.Message):
  _md5sum = "f66648d1c57928da53a1cb39d1189cb5"
  _type = "phasespace/FullState"
...
Vector3  angular
"""
  __slots__ = ['header','pose','twist','accel']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pose.position.x, _x.pose.position.y, _x.pose.position.z, _x.pose.orientation.x, _x.pose.orientation.y, _x.pose.orientation.z, _x.pose.orientation.w, _x.twist.linear.x, _x.twist.linear.y, _x.twist.linear.z, _x.twist.angular.x, _x.twist.angular.y, _x.twist.angular.z, _x.accel.linear.x, _x.accel.linear.y, _x.accel.linear.z, _x.accel.angular.x, _x.accel.angular.y, _x.accel.angular.z,) = _get_struct_19d().unpack(str[start:end])
      return self
